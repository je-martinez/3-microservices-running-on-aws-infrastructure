...
// CONTRACT: Seed these placeholders before importing routes.ts. It transitively
// imports `#shared/config/env`, whose value import runs `parseEnv()` eagerly at
// module load — before `main()` — regardless of the container passed to `buildApp()`.
// None are read at runtime here: `registerSingletons()` is never called for this
// throwaway container.
