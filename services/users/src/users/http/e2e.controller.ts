...
export class E2eController {
  ...
  @Public()
  @HttpCode(200)
  @ApiOperation({ operationId: "e2eCleanup", summary: "[E2E] Delete E2E-sourced users" })
  @ApiResponse({ status: 200, schema: { $ref: "#/components/schemas/E2ECleanupResponse" } })
  async cleanup() {
  ...
  @Get("e2e-identity")
  @HttpCode(200)
  @ApiOperation({ operationId: "e2eIdentity", summary: "[E2E] Read captured identity by email" })
