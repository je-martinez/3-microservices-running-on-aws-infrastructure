...
related:
  ...
  - "[[2026-07-02-users-cognito-webhook]]"
---
...
- [[2026-07-02-users-cognito-webhook]] — implementation plan for JE-38 (Cognito Identity Webhook): persist Cognito identity data via a `POST /v1/webhooks/cognito` endpoint and two new Postgres tables, replacing the earlier SQS-based idea.
