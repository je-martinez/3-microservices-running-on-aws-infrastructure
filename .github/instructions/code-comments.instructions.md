---
applyTo: "**/*.ts,**/*.tsx,**/*.js,**/*.jsx,**/*.mjs,**/*.py,**/*.cs,**/*.go,**/*.tf,**/*.tfvars,**/*.yml,**/*.yaml,**/*.html,**/Makefile*,**/Dockerfile*"
description: "Code comments — describe the final state, never append debugging history"
---
