...
@Component({
  ...
  imports: [RouterLink, LucideArrowLeft, BrandPanel, MobileBrandHeader, Field, ButtonPrimary, ButtonGhost],
  template: `
    <main class="bg-surface-white flex min-h-screen w-full flex-col lg:flex-row">
      ...
      <section class="flex flex-1 flex-col items-center justify-center px-6 py-10 lg:px-10">
        ...
        >
          <a routerLink="/login" class="text-ink-secondary inline-flex w-fit items-center gap-[7px]">
            <svg lucideArrowLeft class="h-4 w-4"></svg>
            <span class="text-sm font-semibold">Back to sign in</span>
          </a>
          ...
          <div class="flex flex-col gap-2.5">
            ...
            <p class="font-body text-ink-secondary text-[14.5px] leading-[1.55] lg:text-base">
              Enter your email and we'll send you a 6-digit code. Nothing to remember, nothing to
              reset.
            </p>
          </div>
          ...
          <app-field
            ...
            help="The code expires 10 minutes after it is sent."
          />
          ...
          <a routerLink="/login" class="block w-full">
