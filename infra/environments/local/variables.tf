...
# WHY: The networking module takes list(object({suffix, cidr, az})), so main.tf
# omits this and uses that module's default. Kept as the declared per-env CIDR
# intent; reshape it to the module's object type to wire it in.
variable "subnets" {
