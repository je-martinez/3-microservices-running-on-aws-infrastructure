---
name: code-comments
description: A comment describes the code as it exists today, never the debugging journey that produced it. Rewrite on edit instead of appending. Five tags only — CONTRACT, WORKAROUND, WHY, WARNING, TODO — and a block over 12 lines is an error.
paths:
  - "**/*.ts"
  - "**/*.tsx"
  - "**/*.js"
