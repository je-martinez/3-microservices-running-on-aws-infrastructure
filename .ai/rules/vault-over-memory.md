---
name: vault-over-memory
description: GOLDEN RULE — durable conventions, decisions, and lessons go into the versioned vault under docs/, never only into an assistant's private memory store. Memory is a pointer, never the record.
paths:
  - "**"
---
