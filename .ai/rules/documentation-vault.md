...
description: The Obsidian vault under docs/ is the source of truth for technical content. Structure, frontmatter, tags, and wikilink conventions, plus the propagation gate that closes a spec or plan.
paths:
  - "**/*.md"
---
