...
description: Every log line carries the shared cross-service context; never log passwords, tokens, request bodies, or plaintext emails. OpenTelemetry is configured through environment variables, never in code. Browser telemetry is not inherited — a new web surface is observable only if written to be.
paths:
  - "**/*.ts"
  - "**/*.js"
  - "**/*.py"
