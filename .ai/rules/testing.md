---
name: testing
description: Every new or changed HTTP endpoint requires three test layers — unit/integration, internal E2E against the service URL, and gateway E2E with a real Cognito JWT. An endpoint without gateway E2E is incomplete.
paths:
  - "**/*.test.*"
  - "**/*.spec.*"
  - "**/test_*.py"
